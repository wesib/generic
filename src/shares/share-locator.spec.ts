  ...
  describe('ShareLocator', () => {
    ...
    beforeEach(() => {
      ...
      mockShare = {
        ...
        valueFor: jest.fn((_consumer, _options?) => afterThe('found', mockSharer)),
      } as Partial<MockObject<Share<string>>> as MockObject<Share<string>>;
    ...
    describe('by share reference', () => {
      it('converts to function', async () => {
        ...
        expect(mockShare.valueFor).toHaveBeenLastCalledWith(mockConsumer, {
          host: undefined,
          local: undefined,
        });
      });
