...
export namespace PageParam {
  ...
  export interface Handle<T, I> {
     ...
     * @param when  When the transfer happens. Either `pre-open`, `pre-replace`, or `return`. The latter is used
     ...
     */
    transfer?(to: Page, when: 'pre-open' | 'pre-replace' | 'return'): Handle<T, I> | undefined;
